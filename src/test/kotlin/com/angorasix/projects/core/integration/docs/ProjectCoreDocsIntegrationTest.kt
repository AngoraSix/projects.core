...
class ProjectCoreDocsIntegrationTest(
    ...
    var projectDescriptor =
        arrayOf<FieldDescriptor>(
            ...
            subsectionWithPath("attributes[]")
                .type(ArrayOfFieldType(Attribute::class.simpleName))
                .description("Array of the attributes that characterize the project"),
            subsectionWithPath("requirements[]")
                .type(ArrayOfFieldType(Attribute::class.simpleName))
    ...
    private fun executeAndDocumentGetSingleProjectRequest() {
        ...
        webTestClient
            .get()
            .uri("/projects-core/{projectId}", elementId)
        ...
        webTestClient
            ...
            .consumeWith(
                document(
                    ...
                    responseFields(
                        fieldWithPath("[]")
                            .type(ArrayOfFieldType(Project::class.simpleName))
